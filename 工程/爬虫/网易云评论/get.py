...
def main():
    baseurl = "https://music.163.com/#/song?id=1499468984"
    #1、爬取网页
    datalist = GetData(baseurl)
    #3、保存数据
    savepath=".\\天军行阵乐-网易评论.xls"                      #.\\表示文件目录；./表示当前文件夹
...
def GetData(baseurl):
    ...
    for item in soup.find_all('div',class_="itm"):  #找到所有div，并且包含class为item的属性。class后加下划线，与系统关键字区分。
        print(item)
    #     data=[]                                     #保存一部电影的信息
    #     item=str(item)
